      ...
      {token ? (
        <div className="flex flex-col content-center justify-center mx-auto">
          <div className="items-center">
            ...
            <p className="mb-16 text-xl leading-8 text-center">
              Here are your requested bookings, waiting for confirmation. <br />
              You will be noticed on e-mail within 2-days if its accepted.
            </p>
            <div>
        ...
        <h1>
          Login to see your bookings! <Link to="/login">- to Login</Link>
        </h1>
      )}
    </>
  );
